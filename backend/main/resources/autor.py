...
class Autor(Resource):
    ...
    def get(self, id):
        try:
            ...
            abort(404, message=str(
                "Error 404 Not Found: No se encuentra el ID del autor."))
    ...
    def delete(self, id):
        try:
            ...
            db.session.rollback()
            abort(404, message=str(
                "404 Not Found: No se encuentra el autor para eliminar. El ID no existe"))
    ...
    def put(self, id):
        try:
            ...
            db.session.rollback()
            abort(404, message=str(
                "Error 404 Not Found: No se encuentra el autor para modificar"))
